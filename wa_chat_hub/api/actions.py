...
from wa_chat_hub.services import (
    ...
    _resolve_whatsapp_source_value,
...
def create_lead_from_conversation():
    ...
    source = payload.get("source") or _resolve_whatsapp_source_value(lead_meta)
    if source and lead_meta.has_field("source"):
        lead_values["source"] = source
    doc = frappe.get_doc(lead_values)

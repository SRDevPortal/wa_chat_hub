...
DEFAULT_AI_DOCTYPE_PERMISSIONS = (
    ...
    ("WA AI Policy Bundle", 1, 0, 0, "Read the Channel Account business-policy bundle."),
    ...
    ("WA AI Agent Profile", 1, 0, 0, "Read configured AI agent profiles."),
    ("WA AI Intent", 1, 0, 0, "Read administrator-owned AI intent definitions."),
    ("WA AI Intent Route", 1, 0, 0, "Read administrator-owned intent routing rules."),
    ("WA AI Workflow", 1, 0, 0, "Read administrator-owned action workflow definitions."),
    ("WA AI Agent Tool", 1, 0, 0, "Read per-agent MCP tool allowlists."),
    ("WA AI Department Profile", 1, 0, 0, "Read department-specific AI configuration."),
    ...
    ("MCP Event", 1, 1, 0, "Read/write MCP execution audit events."),
    ...
    ("Patient", 1, 1, 0, "Read/create patient identity and routing fields for allowed MCP workflows."),
    ("Patient Encounter", 1, 1, 0, "Read/create patient encounters through allowed MCP workflows."),
